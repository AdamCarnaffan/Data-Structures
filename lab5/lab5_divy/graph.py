...
def test():
   ...
   G2 = graph()
   G2.addVertex(6)
   G2.addEdge(0, 1, False, 7)
   G2.addEdge(0, 2, False, 9)
   G2.addEdge(0, 5, False, 14)
   G2.addEdge(1, 3, False, 15)
   G2.addEdge(1, 2, False, 10)
   G2.addEdge(2, 3, False, 11)
   G2.addEdge(2, 5, False, 2)
   G2.addEdge(5, 4, False, 9)
   G2.addEdge(3, 4, False, 6)
